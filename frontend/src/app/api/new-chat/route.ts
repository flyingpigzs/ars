// src/app/api/new-chat/route.ts
// when creating a new chat, the user will be redirected to the chat page with the new chat ID, and the chat history will be saved in a JSON file in the [public/data/chatHistory] folder
...
export async function POST(req: NextRequest) {
  try {
    ...
    const filePath = join(process.cwd(), 'public/data/chatHistory', `${session_id}.json`)
